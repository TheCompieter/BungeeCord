...
class EntityMap_1_17 extends EntityMap
{
    ...
    EntityMap_1_17()
    {
        ...
        addRewrite( 0x05, ProtocolConstants.Direction.TO_CLIENT, false ); // Animation :  PacketPlayOutSculkVibration
        ...
        addRewrite( 0x45, ProtocolConstants.Direction.TO_CLIENT, true ); // Entity Metadata : PacketPlayOutEntityMetadata
        addRewrite( 0x46, ProtocolConstants.Direction.TO_CLIENT, false ); // Attach Entity : PacketPlayOutAttachEntity
        addRewrite( 0x47, ProtocolConstants.Direction.TO_CLIENT, true ); // Entity Velocity : PacketPlayOutEntityVelocity
        addRewrite( 0x48, ProtocolConstants.Direction.TO_CLIENT, true ); // Entity Equipment : PacketPlayOutEntityEquipment
        addRewrite( 0x4C, ProtocolConstants.Direction.TO_CLIENT, true ); // Set Passengers : PacketPlayOutMount
    ...
    public void rewriteClientbound(ByteBuf packet, int oldId, int newId, int protocolVersion)
    {
        ...
        switch ( packetId )
        {
            case 0x46 /* Attach Entity : PacketPlayOutAttachEntity */:
            ...
            case 0x32 /* Combat Event : PacketPlayOutCombatEvent */:
                ...
                break;
            case 0x45 /* EntityMetadata : PacketPlayOutEntityMetadata */:
                DefinedPacket.readVarInt( packet ); // Entity ID
